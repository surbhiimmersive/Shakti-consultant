...
public class ResumeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            if (AppPrefrences.getExperience(ResumeActivity.this).equals("Fresher")) {

                binding.textView90.setText(AppPrefrences.getExperience(ResumeActivity.this));
            } else {
            ...
            binding.textView82.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {

                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    Uri data = Uri.parse("mailto:hr@shakticonsultant.com?subject=" + Uri.encode("Shakti Consultant") + "&body=" + Uri.encode("Shakti Consultant"));
                    intent.setData(data);
                    startActivity(intent);
                }
            });
            binding.textView83.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {

                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    Uri data = Uri.parse("mailto:shakticonsultant@gmail.com?subject=" + Uri.encode("Shakti Consultant") + "&body=" + Uri.encode("Shakti Consultant"));
                    intent.setData(data);
                    startActivity(intent);
                }
            });
            ...
            public void onResponse(Call<GetPersonalInformationResponse> call, Response<GetPersonalInformationResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().isSuccess() == true) {
                        ...
                        binding.textView00.setText("Skill-" + response.body().getData().getSkillname());
