...
import com.shakticonsultant.responsemodel.JobRejectedListDatumResponse;

import java.util.List;

public class RejectedJobListAdapter extends RecyclerView.Adapter<RejectedJobListAdapter.ViewHolder> {

    List<JobRejectedListDatumResponse> list;
    Context context;

    public RejectedJobListAdapter(Context context) {

        this.context = context;
        this.list = list;
    }

    public RejectedJobListAdapter(Context context, List<JobRejectedListDatumResponse> list) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        viewHolder.txtDate.setText("Rejected Date- "+list.get(position).getRejected_date());
