...
public class PaymentInrigationNew extends AppCompatActivity {
    ...
    private static final String TAG = "PaymentInrigationNew";
...
//        Log.d(TAG, "ReqCode : " + CFPaymentService.REQ_CODE);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.phonePe_exists) {
            ...
            CFPaymentService.getCFPaymentServiceInstance().isGPayReadyForPayment(PaymentInrigationNew.this, new GooglePayStatusListener() {
                @Override
                public void isReady() {
...
//                                cfPaymentService.selectUpiClient("com.google.android.apps.nbu.paisa.user");
            ...
            case R.id.amazon: {
                cfPaymentService.doAmazonPayment(PaymentInrigationNew.this, getInputParams(), token, stage);
                break;
            }
            case R.id.gpay: {
                cfPaymentService.gPayPayment(PaymentInrigationNew.this, getInputParams(), token, stage);
                break;
            }
            case R.id.phonePe: {
                cfPaymentService.phonePePayment(PaymentInrigationNew.this, getInputParams(), token, stage);
                break;
            }
            case R.id.web_seamless: {
                cfPaymentService.doPayment(PaymentInrigationNew.this, getSeamlessCheckoutParams(), token, stage);
                break;
            }
        }
    }
