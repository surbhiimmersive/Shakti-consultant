...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cd=new ConnectionDetector(ResetPasswordActivity.this);
binding.textView14.setText("Reset Password");
        /* show keyboard */
...
Intent i=new Intent(ResetPasswordActivity.this,PasswordResetActivity.class);
i.putExtra("userid",response.body().getData().getUser_id());
startActivity(i);
                       // startActivity(new Intent(ForgotPasswordActivity.this, PasswordResetActivity.class));
                    }  else {
                        Utils.showFailureDialog(ResetPasswordActivity.this, response.body().getMessage());
                    ...
                    Utils.showFailureDialog(ResetPasswordActivity.this, "Record not found");
            ...
            public void onFailure(Call<ForgotResponse> call, Throwable t) {
                binding.progressBar.setVisibility(View.GONE);
                Utils.showFailureDialog(ResetPasswordActivity.this, "Something went wrong!");
            }
        });
    }
